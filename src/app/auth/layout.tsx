...
const AuthLayout = ({
  ...
  return (
    <div className="flex h-full items-center justify-center bg-auth py-6">
      <div className="flex h-full w-2/3 gap-9 rounded-3xl  p-9 shadow-auth max-2xl:w-3/4 max-lg:w-11/12 bg-white">
