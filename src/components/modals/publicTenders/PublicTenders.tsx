...
import PublicInquiry from "./PublicInquiry";

const PublicTenders = () => {
  const data: Array<{
    text: string;
    value: "publicInquiry" | "documents";
  }> = [
    { text: "اطلاعات", value: "publicInquiry" },
    { text: "مدارک", value: "documents" },
  ];

  const [activeTab, setActiveTab] = useState<"publicInquiry" | "documents">(
    "publicInquiry",
  );
