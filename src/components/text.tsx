...
import Slider from "@/components/app/site/Slider";
  ...
  return (
    <div className="flex h-full flex-col bg-white">
      ...
      <div className="bg-common py-20">
        <div className="bg-common-dark container mx-auto flex justify-between rounded-xl p-14">
      ...
      <div className="bg-white text-black">
        <div className="container mx-auto flex flex-col gap-48 py-6">
          ...
          <div className="flex flex-col items-center gap-20">
            ...
            <Button className="bg-common-dark rounded-lg px-16 py-4 text-white">
              {"مشاهده بیشتر"}
            </Button>
          </div>
        </div>
        ...
        <div className="mt-32 flex w-full flex-col items-center justify-center gap-16 bg-events bg-no-repeat py-16 text-white">
        ...
        <div className="bg-common-dark flex flex-col items-center gap-24 px-7 pb-40 pt-32 text-white">
